...
export default function About () {
	...
	<TextPage title="Manga and Anime Society Kharagpur">
		<Emphasis isRed big center> Konnichiwa minna-san!!! We are Manga and Anime Society Kharagpur (MASK). </Emphasis>
		<h2> What is MASK? </h2>
		<p>
		...
		<p>
			At MASK, we involve ourselves in a variety of things. We regularly release anime-related content such as <Link isRed href="/newsletters">newsletters</Link>, <Link isRed href="/videos">AMVs</Link>, <Link isRed href="/Linkrt">fan arts</Link> etc. We also hold <Link isRed href="/events">events</Link> for fellow anime enthusiasts on and around the campus. Except them, we also have some activites exclusive for the members of the society. (Join us to enjoy some insider benefits.)
		</p>
		<br/>
		<p>
			We also accept fan art and AMVs from outside society and publish them on social media while featuring the creator. If you want to make any AMV/ fanart submissions, you can do it <Link isRed href="/submissions">here</Link>.
		</p>
		<br/>
		<h2> Teams </h2>
		<p>
