...
export default function TermsPage () {
	return (<>
		...
		<TextPage title="Terms and Conditions">
			...
			<p>You must not:</p>
			<ul>
				<li>Republish material from MASK</li>
				<li>Sell, rent or sub-license material from MASK</li>
				<li>Reproduce, duplicate or copy material from MASK</li>
				<li>Redistribute content from MASK</li>
			</ul>
			<br />
			<p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <Link href="https://www.privacypolicies.com/blog/sample-terms-conditions-template/">Terms And Conditions Template</Link>.</p>

			<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. <Link href="https://kgpmask.club/" target="_blank" rel="noopener noreferrer">https://kgpmask.club/</Link> does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of <Link href="https://kgpmask.club/" target="_blank" rel="noopener noreferrer">https://kgpmask.club/</Link>,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, <Link href="https://kgpmask.club/" target="_blank" rel="noopener noreferrer">https://kgpmask.club/</Link> shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

			<p><Link href="https://kgpmask.club/" target="_blank" rel="noopener noreferrer">https://kgpmask.club/</Link> reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p><br/>
			...
			<p>You hereby grant <Link href="https://kgpmask.club/" target="_blank" rel="noopener noreferrer">https://kgpmask.club/</Link> a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p><br/>
			...
			<br/><br/>
			<em>Last edited on: 28-11-2023</em>
			<br/><br/>
		</TextPage>
	</>);
}
